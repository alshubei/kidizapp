...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        "fun": "0 8px 0 0 hsl(var(--border)), 0 12px 24px rgba(0,0,0,0.15)",
        "fun-sm": "0 4px 0 0 hsl(var(--border)), 0 6px 12px rgba(0,0,0,0.1)",
      },
    },
  },
